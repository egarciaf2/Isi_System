                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="txtNombre" name="txtNombre" value="{{ old('txtNombre', $empleado->nombre) }}" placeholder="Nombre de empleado">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        <label for="txtApellido">Apellido</label>
                                        <input type="text" class="form-control" id="txtApellido" name="txtApellido" value="{{ old('txtApellido', $empleado->apellido) }}" placeholder="Apellido de empleado">
                                    </div>
                                </div>
                                            ...
                                            @if (isset($empresas) and count($empresas) > 0)
                                                @foreach ($empresas as $empresa)
                                                    <option value="{{ ($empresa->id)? $empresa->id : '' }}"
                                                        ...
                                                        {{ (old('slcEmpresa', $empleado->idEmpresa) ==  $empresa->id)? 'selected' : ''}}>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="txtEmail" name="txtEmail" value="{{ old('txtEmail', $empleado->email) }}" placeholder="Ingrese correo electronico">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                    <div class="form-group">
                                        <label for="txtTelefono">Teléfono</label>
                                        <input type="number" class="form-control" id="txtTelefono" name="txtTelefono" value="{{ old('txtTelefono', $empleado->telefono) }}" min="8" placeholder="Ingrese telefono">
                                    </div>
                                </div>
                            </div>  
